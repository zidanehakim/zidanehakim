...
[![My Skills](https://skillicons.dev/icons?i=mysql,mongodb,postgres,redis,sqlite,docker,kubernetes,nginx,git,gitlab,github,githubactions,grafana,prometheus,kafka,rabbitmq,gcp,postman,cmake,spring,gradle,express,react,redux,jest,npm,fastapi,flask,visualstudio,vscode,vim,notion,md,latex)](https://skillicons.dev)
